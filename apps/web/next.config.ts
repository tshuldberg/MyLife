...
const nextConfig: NextConfig = {
  ...
  transpilePackages: ['@mylife/ui', '@mylife/module-registry', '@mylife/db', '@mylife/books', '@mylife/fast', '@mylife/entitlements', '@mylife/billing-config', '@mylife/recipes', '@mylife/car', '@mylife/habits', '@mylife/meds', '@mylife/surf', '@mylife/workouts', '@mylife/homes', '@mylife/words', '@mybooks/shared', '@mybooks/ui', '@mybudget/shared', '@mybudget/ui', '@myrecipes/shared', '@myrecipes/ui'],
  webpack: (config) => {
